...
list_ip = ip.split(".")
template = template.format(list_ip[0], list_ip[1], list_ip[2], list_ip[3],
                           "{0:08b}".format(int(list_ip[0])), "{0:08b}".format(int(list_ip[1])),
                           "{0:08b}".format(int(list_ip[2])), "{0:08b}".format(int(list_ip[3])))
